...
export type DiscordLogo_IconProps = {
	className?: string;
...
export const DiscordLogo_Icon: FunctionComponent<DiscordLogo_IconProps> = (
	props,
) => {
	const { viewBox } = props;
