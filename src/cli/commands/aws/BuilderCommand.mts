...
} from "../../../sdk/aws/clients/Codebuild.mjs";
import { Policy } from "../../../sdk/aws/clients/Policy.mjs";
import { Role } from "../../../sdk/aws/clients/Role.mjs";
import { S3 } from "../../../sdk/aws/clients/S3.mjs";
import { SystemsManager } from "../../../sdk/aws/clients/SystemsManager.mjs";
import {
...
export const BuilderProjectParameter = (principal?: string) =>
	`/fourtwo/${principal ? `${principal}` : "_principal"}/builder/CodebuildProjectArn`;
...
export const BuilderCommand = async () => {
	return async () =>
		buildCommand({
			loader: async () => {
				return async (flags: Flags) => {
					...
					);
					{
						...
						let parameter = BuilderProjectParameter();
						let scopedParameter = BuilderProjectParameter(
							await principalName(),
						);
