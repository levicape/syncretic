...
export type WebhookFilterType = "BASE_REF" | "HEAD_REF" | "ACTOR_ACCOUNT_ID";

type ImagesFor<T extends keyof typeof AWS_CODEBUILD_IMAGES> =
	(typeof AWS_CODEBUILD_IMAGES)[T][number];
...
type EnvironmentVariableType =
	...
	| "PARAMETER_STORE"
	| "SECRETS_MANAGER";
export type SourceType = "CODECOMMIT" | "CODEPIPELINE" | "GITHUB" | "S3";
