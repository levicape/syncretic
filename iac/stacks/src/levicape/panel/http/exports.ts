...
export const FourtwoPanelHttpStackrefRoot = "panel-http" as const;

export const FourtwoPanelHttpStackExportsZod = z
	.object({
				...
				stages: z.array(
					z.object({
						actions: z.array(
							z.object({
								category: z.string(),
								configuration: z.record(z.string().nullish()).nullish(),
								name: z.string(),
								provider: z.string(),
								runOrder: z.number(),
							}),
		...
		fourtwo_panel_http_routemap: z.record(LambdaRouteResourceZod),
	})
	.passthrough();
