...
import {
	FourtwoPanelWWWRootExportsZod,
	FourtwoPanelWWWRootSubdomain,
} from "./exports";
		...
		([
			...
			const exported = {
				fourtwo_panel_wwwroot_imports: {
					[FourtwoApplicationRoot]: {
						[FourtwoPanelHttpStackrefRoot]: $http,
						[FourtwoPanelWebStackrefRoot]: $web,
					},
				},
				fourtwo_panel_wwwroot_cloudfront,
				fourtwo_panel_wwwroot_codebuild,
				...
				fourtwo_panel_wwwroot_imports: {
					[FourtwoApplicationRoot]: {
						[FourtwoPanelHttpStackrefRoot]: typeof $http;
						[FourtwoPanelWebStackrefRoot]: typeof $web;
					};
				};
			};
